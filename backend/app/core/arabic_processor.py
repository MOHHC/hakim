...
_LEXICON_PATH = Path(__file__).resolve().parents[1] / "data" / "lexicon" / "lebanese_medical.json"
...
_FRANCO_PATTERN_RE = re.compile(r"\b(?:[a-zA-Z]+[23567890][a-zA-Z0-9]*|[a-zA-Z0-9]*[23567890][a-zA-Z]+)\b")
_FRANCO_MAP: list[tuple[str,str]] = [
    ("sh","ش"),("kh","خ"),("gh","غ"),("th","ث"),("ch","ش"),("ph","ف"),("dh","ذ"),
    ("2","أ"),("3","ع"),("5","خ"),("6","ط"),("7","ح"),("8","غ"),("9","ق"),
    ("a","ا"),("b","ب"),("t","ت"),("j","ج"),("d","د"),("r","ر"),("z","ز"),("s","س"),
    ("f","ف"),("k","ك"),("l","ل"),("m","م"),("n","ن"),("h","ه"),("w","و"),("y","ي"),
    ("q","ق"),("i","ي"),("o","و"),("u","و"),("e",""),("p","ب"),("v","ف"),("g","ج"),
    ("x","كس"),("c","ك"),
]
_FRANCO_REGEX = re.compile("|".join(re.escape(s) for s,_ in _FRANCO_MAP), re.IGNORECASE)
    ...
    def transliterate(self, text: str) -> str:
        ...
        for token in tokens:
            ...
            if ratio > 0.4:
                ...
                out.append(_FRANCO_REGEX.sub(
                    lambda m: _FRANCO_REPLACE_MAP.get(m.group(0).lower(), m.group(0)), token
                ))
        return " ".join(out)
